...
/**
 * 
 * @author Bambang Hariyanto,Ir.MT Inspired by : Theory and problems of
 *         programming with Pascal Byron S. Gottriied, page 155
 * 
 * 
 * Java : How to Program Deitel Deitel, page 276, exercise 6.37
 * 
 */
...
public class HanoiTowerToy {
	...
	public String toString() {
		str = "Menara Hanoi dengan " + nrOfDisk + " piringan \n" + "Asal : "
				+ originPole + " Tujuan : " + destPole + " Perantara : "
				+ otherPole + "\n" + str;
		return str;
	}
	...
	private void blockMove(int nrOfDisk, char originPole, char destPole,
			char otherPole) {
		if (nrOfDisk > 0) {
