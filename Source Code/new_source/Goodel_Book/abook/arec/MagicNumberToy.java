...
/**
 * 
 * @author Bambang Hariyanto,Ir.MT Inspired by : Data structures and program
 *         design in Pascal Larry Nyhoff - Sanford Leestma, page 76 Exersize 20
 */
...
public class MagicNumberToy {
	...
	static void test01() {
		...
		if (t.isValid())
			...
			System.out.println("Nilai sisi yang dimasukkan tidak sah!");
		System.out.println("");
	}
